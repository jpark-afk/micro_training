 ...
 * - Created external documentation for DDS_DomainParticipantQos_initialize,
 *   DDS_DomainParticipantQos_copy, DDS_DomainParticipantQos_is_equal,
 *   DDS_DomainParticipantFactoryQos_initialize,DDS_DomainParticipantFactoryQos_copy,
...
struct DDSCPPDllExport DDS_DiscoveryQosPolicy
{
    ...
    DDSC_CPP_QOS_METHODS(DDS_DiscoveryQosPolicy)
};
...
/*ce \dref_DomainParticipantQos_is_equal
 */
MUST_CHECK_RETURN DDSCDllExport DDS_Boolean
