 ...
 * - Added external documentation for DDS_DataWriterQos_initialize,
 *   DDS_DataWriterQos_copy, DDS_DataWriterQos_is_equal,
 *   DDS_PublisherQos_initialize, DDS_PublisherQos_copy,
 *   DDS_PublisherQos_is_equal
...
/*ce \dref_DataWriterQos_is_equal
 */
...
struct DDS_DataWriterListener
{
    ...
    /*ce \dref_DataWriterListener_on_reliable_sample_unacknowledged
     */
    DDS_DataWriterListener_ReliableSampleUnacknowledgedCallback
...
/*ci \brief Untyped register_instance API 
 * 
 * \param[in] self Untyped writer
 * \param[in] instance_data Instance to register
 * 
 * \return RETCODE_OK on success, one of the standard return code on failure
 */
...
/*ci \brief Untyped register_instance_w_timestamp API 
 * 
 * \param[in] self Untyped writer
 * \param[in] instance_data Instance to register
 * \param[in] source_timestamp User defined time the instance was registered
 * 
 * \return RETCODE_OK on success, one of the standard return code on failure
 */
DDSCDllExport DDS_InstanceHandle_t
...
/*ci \brief Untyped unregister_instance 
 * 
 * \param[in] self Untyped writer
 * \param[in] instance_data Instance to unregister or NULL if handle is different from NULL
 * \param[in] handle Handle returned by a previous call to register or DDS_HANDLE_NIL
 *                   to use instance_data.
 * 
 * \return RETCODE_OK on success, one of the standard return code on failure
 */
DDSCDllExport DDS_ReturnCode_t
...
/*ci \brief Untyped dispose
 * 
 * \param[in] self Untyped writer
 * \param[in] instance_data Instance to dispose or NULL if handle is different from NULL
 * \param[in] handle Handle returned by a previous call to register or DDS_HANDLE_NIL
 *                   to use instance_data.
 * 
 * \return RETCODE_OK on success, one of the standard return code on failure
 ...
 * \param[in] handle Handle returned by a previous call to register or DDS_HANDLE_NIL
 *                   to use instance_data.
 * \param[in] source_timestamp User defined time the instance was disposed
 * 
 * \return RETCODE_OK on success, one of the standard return code on failure
 */
DDSCDllExport DDS_ReturnCode_t
...
/*ci \brief Untyped write call
 * 
 * \param[in] self Untyped writer
 * \param[in] instance_data Instance to write
 * \param[in] handle Handle returned by a previous call to register or DDS_HANDLE_NIL
 *                   to use instance_data.
 * 
 * \return RETCODE_OK on success, one of the standard return code on failure
...
/*ci \brief Untyped write_w_timestamp call
 * 
 * \param[in] self Untyped writer
 * \param[in] instance_data Instance to write
 * \param[in] handle Handle returned by a previous call to register or DDS_HANDLE_NIL
 *                   to use instance_data.
 * \param[in] source_timestamp User defined time the instance was written
 * 
 * \return RETCODE_OK on success, one of the standard return code on failure
 */
DDSCDllExport DDS_ReturnCode_t
...
#ifndef RTI_CERT
/*ci \brief Assert an instance in the datawriter to reserve space for it
 * 
 * \param[in] datawriter Datawriter to reserve space in
 *
 * \return RETCODE_OK on success, one of the standard return code on failure
 */
DDSCDllExport DDS_ReturnCode_t
...
#ifndef RTI_CERT
/*ci \brief Remove a previously reserved instance in the datawriter
 * 
 * \param[in] datawriter Datawriter to remove the instance from
 *
 * \return RETCODE_OK on success, one of the standard return code on failure
 */
DDSCDllExport DDS_ReturnCode_t
...
/*Forward declaration of the DataReaderQos
 */
