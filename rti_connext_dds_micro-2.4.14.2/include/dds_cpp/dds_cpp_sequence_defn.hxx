...
TSeq::TSeq()
{
    /* This is to avoid UNINIT_CTOR in Coverity */
    this->_contiguous_buffer = NULL;
    this->_maximum = 0;
    this->_length = 0;
    this->_element_size = 0;
    this->_token1 = NULL;
    this->_token2 = NULL;
    this->_flags = 0;
...
{
    /* Avoid UNINIT_CTOR warnings in Coverity */
    this->_contiguous_buffer = NULL;
    this->_maximum = 0;
    this->_length = 0;
    this->_element_size = 0;
...
struct FooSeq {
    ...
    */
    ...
    /*e \dref_FooSeq_new_from_sequence
     */
