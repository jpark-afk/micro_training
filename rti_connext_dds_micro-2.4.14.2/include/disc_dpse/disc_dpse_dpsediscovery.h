/*
 * FILE: disc_dpse_dpsediscovery.h - DPSE API
 *
 * (c) Copyright 2011-2021 Real-Time Innovations,
 *
 * All rights reserved.
 *
 ...
 * - Corrected filename in FILE comment
...
DPSE_DiscoveryPluginProperty_initialize(
            struct DPSE_DiscoveryPluginProperty *self);
