 ...
 * - Removed constant UDP_MAX_PACKET_LENGTH when 
 *   builtin UDP plugin is disabled. 
 * 15jun2021,tk MICRO-3053/PR.29151
 * - Defined UDP_MAX_PACKET_LENGTH to 65507, the maximum UDP payload.
 ...
 */
#define UDP_MAX_PACKET_LENGTH 65507
