 ...
 * - Removed the following constants when builtin UDP plugin is disabled
 *   NETIO_PROTOCOL_UDP
 ...
 * 19oct2020,tk MICRO-2575/PR#28172 Removed NETIO_RTPS_FLAGS_HEADER_EXTN_LENGTH
...
struct NETIO_RtpsInfo
{
    ...
    /*ci \brief need_byte_swap of stream. If header is not deserialized yet
     * the value will be CDR_BYTESWAP_INVALID. This is useful to deserialize
     * header only once.
     */
...
{ \
    ...
    {{NULL,NULL},\
     {NULL,NULL,CDR_BYTESWAP_INVALID,0,\
