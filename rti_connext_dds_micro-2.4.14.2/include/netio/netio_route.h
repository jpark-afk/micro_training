 ...
 * - Added transport parameter to NETIO_BindResolver_reserve_addresses
 * - Updated comments for NETIO_RouteResolver_add_peer
 * 21feb2021,tk MICRO-2868/PR#28741
 *   - Corrected incorrect argument name in function header comment and
 *     declaration for NETIO_RouteResolver_lookup_route().
