 ...
 * --------------------
 * 06apr2021,tk MICRO-3001 / PR.29028
 *   - Corrected description of REDA_Indexer_iterator_next
...
/*ci
 * \brief Return the next element in the iterator
 *
 * \details
 *
 ...
 *
 * \param[in] iterator Iterator to return the next element from.
 *
 *
