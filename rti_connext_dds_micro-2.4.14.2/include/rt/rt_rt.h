 ...
 * --------------------
 * 05aug2022,tk MICRO-3710/PR.30762
 * - Added missing documentation reference for RT_ComponentFactoryId_T
 * 27may2022,am MICRO-3537/PR.30409
 * - Removed constant RT_COMPONENT_INSTANCE_UDP when builtin UDP plugin is 
 *   disabled. 
 * 21jul2021,tk MICRO-3045 Fixed filenames and dates in file header comments
 * 13apr2021,tk MICRO-3028/PR.28960
 * - Made documentation for RT_ComponentFactoryId_set_name external
 * 21feb2021,tk MICRO-2884/PR#28781
 *   - Updated RT_ComponentFactoryId_INITIALIZER to initialize the
 *     full array.
