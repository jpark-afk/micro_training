...
/*e
 * \brief A DATA submessage whose sequence number was previously received was 
 * discarded. This is not an error and may happen for example when a message is 
 * retransmitted.
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_DATA_ALREADY_RECEIVED_EC                   (RTPS_LOG_BASE + 52)
#define RTPS_LOG_DATA_ALREADY_RECEIVED(\
        level_,\
        s_high_,\
        s_low_,\
        lead_high_,\
        ...
        instance_id_,\
        object_id_) \
OSAPI_LOG_ENTRY_CREATE((level_),RTPS_LOG_DATA_ALREADY_RECEIVED_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM,RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("s_high",(RTI_INT32)(s_high_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("s_low",(RTI_UINT32)(s_low_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("lead_high",(RTI_INT32)(lead_high_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("lead_low",(RTI_UINT32)(lead_low_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("host_id",(RTI_UINT32)(host_id_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("app_id",(RTI_UINT32)(app_id_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("instance_id",(RTI_UINT32)(instance_id_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("object_id",(RTI_UINT32)(object_id_),RTI_TRUE)\
...
OSAPI_LOG_ENTRY_CREATE((level_),RTPS_LOG_SET_GAP_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM,RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("start",(RTI_INT32)(start_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("end",(RTI_INT32)(end_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("suffix",(RTI_INT32)(sffx_),RTI_TRUE)
...
#define RTPS_LOG_NEGATIVE_RESERVATION_COUNT(level_) \
OSAPI_LOG_ENTRY_ADD((level_),RTPS_LOG_NEGATIVE_RESERVATION_COUNT_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM)
 ...
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_MISSING_CHECKSUM_LENGTH_EC       (RTPS_LOG_BASE + 149)
 ...
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_UNSUPPORTED_EC                   (RTPS_LOG_BASE + 150)
 ...
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_LENGTH_DESERIALIZE_ERROR_EC      (RTPS_LOG_BASE + 151)
 ...
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_INCONSISTENT_LENGTH_EC           (RTPS_LOG_BASE + 152)
 ...
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_CHECKSUM_DESERIALIZE_ERROR_EC    (RTPS_LOG_BASE + 153)
 ...
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_CHECKSUM_ERROR_EC                (RTPS_LOG_BASE + 154)
#define RTPS_LOG_CHECKSUM_CHECKSUM_ERROR(level_) \
OSAPI_LOG_ENTRY_ADD((level_),RTPS_LOG_CHECKSUM_CHECKSUM_ERROR_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM)

/*e
 * \brief A DATA_BATCH submessage whose sequence number was previously received 
 * was discarded. This is not an error and may happen for example when a message 
 * is retransmitted.
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_DATA_BATCH_ALREADY_RECEIVED_EC            (RTPS_LOG_BASE + 155)
#define RTPS_LOG_DATA_BATCH_ALREADY_RECEIVED(\
        level_,\
        s_high_,\
        s_low_,\
        lead_high_,\
        ...
        instance_id_,\
        object_id_) \
OSAPI_LOG_ENTRY_CREATE((level_),RTPS_LOG_DATA_BATCH_ALREADY_RECEIVED_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM,RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("s_high",(RTI_INT32)(s_high_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("s_low",(RTI_UINT32)(s_low_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("lead_high",(RTI_INT32)(lead_high_),RTI_FALSE)\
...
/*e
 * \brief Received a DATA submessage with an out-of-order sequence number. 
 * \details The received sequence number is higher than the lowest, 
 *          next expected sequence number. This is not an error.
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_DATA_SN_OUT_OF_ORDER_EC                   (RTPS_LOG_BASE + 156)
#define RTPS_LOG_DATA_SN_OUT_OF_ORDER(\
        level_,\
        s_high_,\
        s_low_,\
        lead_high_,\
        ...
        instance_id_,\
        object_id_) \
OSAPI_LOG_ENTRY_CREATE((level_),RTPS_LOG_DATA_SN_OUT_OF_ORDER_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM,RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("s_high",(RTI_INT32)(s_high_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("s_low",(RTI_UINT32)(s_low_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("lead_high",(RTI_INT32)(lead_high_),RTI_FALSE)\
...
/*e
 * \brief Received a DATA_BATCH submessage with an out-of-order sequence number. 
 * \details The received sequence number is higher than the lowest, 
 *          next expected sequence number. This is not an error.
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_DATA_BATCH_SN_OUT_OF_ORDER_EC                   (RTPS_LOG_BASE + 157)
#define RTPS_LOG_DATA_BATCH_SN_OUT_OF_ORDER(\
        level_,\
        s_high_,\
        s_low_,\
        lead_high_,\
        ...
        instance_id_,\
        object_id_) \
OSAPI_LOG_ENTRY_CREATE((level_),RTPS_LOG_DATA_BATCH_SN_OUT_OF_ORDER_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM,RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("s_high",(RTI_INT32)(s_high_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_UINT("s_low",(RTI_UINT32)(s_low_),RTI_FALSE)\
        OSAPI_LOG_ENTRY_ADD_INT("lead_high",(RTI_INT32)(lead_high_),RTI_FALSE)\
...
/*e
 * \brief The property specifies an invalid custom256 checksum function
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_INVALID_CUSTOM256_EC             (RTPS_LOG_BASE + 206)
#define RTPS_LOG_CHECKSUM_INVALID_CUSTOM256(level_,class_,func_) \
OSAPI_LOG_ENTRY_ADD_2INT((level_),RTPS_LOG_CHECKSUM_INVALID_CUSTOM256_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM ,\
        "class",(RTI_INT32)(class_),"function", (func_ == NULL ? 0 : 1))

/*e
 * \brief The property specifies an invalid custom32 checksum function
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_INVALID_CUSTOM32_EC              (RTPS_LOG_BASE + 207)
#define RTPS_LOG_CHECKSUM_INVALID_CUSTOM32(level_,class_,func_) \
OSAPI_LOG_ENTRY_ADD_2INT((level_),RTPS_LOG_CHECKSUM_INVALID_CUSTOM32_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM ,\
        "class",(RTI_INT32)(class_),"function", (func_ == NULL ? 0 : 1))

/*e
 * \brief The property specifies an invalid custom64 checksum function
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_INVALID_CUSTOM64_EC              (RTPS_LOG_BASE + 208)
#define RTPS_LOG_CHECKSUM_INVALID_CUSTOM64(level_,class_,func_) \
OSAPI_LOG_ENTRY_ADD_2INT((level_),RTPS_LOG_CHECKSUM_INVALID_CUSTOM64_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM ,\
        "class",(RTI_INT32)(class_),"function", (func_ == NULL ? 0 : 1))

/*e
 * \brief The property specifies an invalid custom128 checksum function
 * \ingroup RTPSLogCodesClass
 */
#define RTPS_LOG_CHECKSUM_INVALID_CUSTOM128_EC             (RTPS_LOG_BASE + 209)
#define RTPS_LOG_CHECKSUM_INVALID_CUSTOM128(level_,class_,func_) \
OSAPI_LOG_ENTRY_ADD_2INT((level_),RTPS_LOG_CHECKSUM_INVALID_CUSTOM128_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM ,\
        "class",(RTI_INT32)(class_),"function", (func_ == NULL ? 0 : 1))
