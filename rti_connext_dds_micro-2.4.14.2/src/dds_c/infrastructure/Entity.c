 ...
 * - Updated comments to comply with the coding standards.
 * 20oct2021,tk MICRO-3311/PR.29816
 * - Removed race-condition in check if an entity is already enabled in
 *   DDS_Entity_enable and call the entity specific enable directly.
                     ...
                     RTIDDS_EntityGetInstanceHandleFunction get_instance_handle)
{
    OSAPI_PRECONDITION_ALWAYS((enable == NULL) ||
              ...
              OSAPI_Log_entry_add_pointer("enable",
                  enable == NULL ? NULL : (void*)0x1,RTI_FALSE);
              OSAPI_Log_entry_add_pointer("get_instance_handle",
                  get_instance_handle == NULL ? NULL : (void*)0x1,RTI_TRUE);)
...
DDS_Entity_get_instance_handle(DDS_Entity *self)
{
    ...
    OSAPI_PRECONDITION_ALWAYS((self == NULL) ||
                ...
                (self == NULL ? 
                NULL : (self->get_instance_handle == NULL ? NULL : (void*)0x1)),RTI_TRUE);)
