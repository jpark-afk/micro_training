            ...
            void *param)
{
    ...
    return DDS_CdrQosPolicy_get_header_max_size_serialized(0) +
           DPDE_SubscriptionBuiltinTopicDataTypePlugin_get_parameters_max_size_serialized(0);
                                                      ...
                                                      void *param)
{
    ...
    participant = DDS_Subscriber_get_participant(DDS_DataReader_get_subscriber(datareader));
    qos = DDS_DataReader_get_qos_ref(datareader);
    ...
    if (!DDS_CdrQosPolicy_serializeLocator(stream,
                    qos->data->unicast_locator,RTPS_PID_UNICAST_LOCATOR6))
    {
        return RTI_FALSE;
    }
    ...
    if (!DDS_CdrQosPolicy_serializeLocator(stream,
                    qos->data->multicast_locator,RTPS_PID_MULTICAST_LOCATOR6))
    {
        return RTI_FALSE;
    }
...
DPDE_SubscriptionBuiltinTopicData_deserialize_pv(RTI_BOOL *ok,
        ...
        DDS_UnsignedShort parameterLength,void *param)
{
    ...
    switch (parameterId)
    {
        ...
        case RTPS_PID_UNICAST_LOCATOR6:
            *ok = DDS_CdrQosPolicy_deserializeLocator(
                    stream, &topic_data->unicast_locator,parameterId,plugin);
            break;
        case RTPS_PID_MULTICAST_LOCATOR6:
            *ok = DDS_CdrQosPolicy_deserializeLocator(
                    stream, &topic_data->multicast_locator,parameterId,plugin);
            break;
                                            ...
                                            void *param)
{
    ...
    OSAPI_Heap_allocate_struct(sample,
    ...
    return DDS_SubscriptionBuiltinTopicData_initialize(
                                                ...
                                                void *param)
{
    ...
    return
        DDS_Cdr_deserializeParameterSequence(
                ...
                DPDE_SubscriptionBuiltinTopicData_deserialize_pv,param);
}
...
RTI_PRIVATE struct NDDS_Type_Plugin DPDE_fv_SubscriptionBuiltinTopicDataTypePlugin =
{
    {0,0},
    NULL,
    NULL,
...
{
    return &DPDE_fv_SubscriptionBuiltinTopicDataTypePlugin;
}
