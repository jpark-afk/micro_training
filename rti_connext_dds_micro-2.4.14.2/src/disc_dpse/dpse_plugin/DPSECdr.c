                            ...
                            void *param)
{
    ...
    if (!CDR_Stream_serialize_char(stream,&product_version->major))
    {
        return RTI_FALSE;
    }

    if (!CDR_Stream_serialize_char(stream,&product_version->minor))
    {
        return RTI_FALSE;
    }

    if (!CDR_Stream_serialize_char(stream,&product_version->release))
    {
        return RTI_FALSE;
    }

    if (!CDR_Stream_serialize_char(stream,&product_version->revision))
    {
        return RTI_FALSE;
    }
                                       ...
                                       void *param)
{
    ...
    if (!CDR_Stream_deserialize_char(stream,&product_version->major))
    {
        return RTI_FALSE;
    }

    if (!CDR_Stream_deserialize_char(stream,&product_version->minor))
    {
        return RTI_FALSE;
    }

    if (!CDR_Stream_deserialize_char(stream,&product_version->release))
    {
        return RTI_FALSE;
    }

    if (!CDR_Stream_deserialize_char(stream,&product_version->revision))
    {
        return RTI_FALSE;
    }
