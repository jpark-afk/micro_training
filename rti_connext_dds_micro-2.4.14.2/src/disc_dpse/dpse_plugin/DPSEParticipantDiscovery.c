 ...
 * --------------------
 * 21feb2021,tk MICRO-2870/PR#28747
 *   - Updated function comment for
 ...
 *
 * This function reschedules the timeout manually and thus always returns
        ...
        DDS_Boolean new_event)
{
    ...
    /* Send out the initial participant announcements, if any */
    if (dpse_plugin->properties.initial_participant_announcements > 0)
    {
