/*
 * FILE: DPSEVersion.c - DPSEVersion implementation
 *
...
RTI_PRIVATE const char* const DPSE_Version_fv_String=
                                RTIME_BUILD_STRING_BUILDER("rti_me_discdpse");

const char*
DPSE_DiscoveryFactory_get_version(void)
{
    return DPSE_Version_fv_String;
}
