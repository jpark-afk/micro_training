/*
 * FILE: freertosString.c - FreeRTOS string functions
 *
 * Copyright 2014-2021 Real-Time Innovations, Inc.
 * 
 * All rights reserved.
 *
 ...
 * --------------------
 * 15oct2014,eh  Created, based on posixString.c
 *
 */
/*ce
 * \file
 * \brief FreeRTOS implementation of OSAPI string routines
 */
