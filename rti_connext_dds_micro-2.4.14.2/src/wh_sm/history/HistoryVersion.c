/*
 * FILE: HistoryVersion.c - Writer History Version implementation
 *
...
RTI_PRIVATE const char* const WHSM_Version_fv_String =
                                    RTIME_BUILD_STRING_BUILDER("rti_me_whsm");

const char*
WHSM_HistoryFactory_get_version(void)
{
    return WHSM_Version_fv_String;
}
