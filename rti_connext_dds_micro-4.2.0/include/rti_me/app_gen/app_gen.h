...
struct APPGENDllExport ComponentFactoryUnregisterModel
{
     ...
     * the component.
     */
    struct RT_ComponentFactoryProperty **unregister_property;

    /*ci
     * \brief Pointer to the component factory listener used to unregister
     * the component.
     */
    struct RT_ComponentFactoryListener **unregister_listener;
};
...
struct APPGENDllExport ComponentFactoryRegisterModel
{
     ...
     * the component.
     */
    RT_ComponentFactoryI_get_interface_T register_intf;

    /*ci
     * \brief Pointer to the component factory properties used to register 
     * the component.
     */
    struct RT_ComponentFactoryProperty *register_property;

    /*ci
     * \brief Pointer to the component factory listener used to register
     * the component.
     */
    struct RT_ComponentFactoryListener *register_listener;
};
