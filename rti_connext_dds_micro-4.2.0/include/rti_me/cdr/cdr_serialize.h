...
/*ci \brief Deserialize Long Long */
#define CDR_deserialize_long_long(__buf,__inst,_b) \
    CDR_deserialize_unsigned_long_long(__buf,((RTI_UINT64*)__inst),_b)
...
/*ci
 * \brief
 * Deserialize a string from a stream without making a copy
 *
 * \param[in] cdrs Serialization stream
 * \param[out] string Pointer to string in stream
...
#define CDR_Stream_serialize_boolean(__s,__i) \
    CDR_Stream_serialize_char(__s,((CDR_Char*)__i))

/*ci \brief Deserialize boolean from stream */
#define CDR_Stream_deserialize_boolean(__s,__i) \
    CDR_Stream_deserialize_char(__s,((CDR_Char*)__i))
...
#if CDR_ENABLE_32WCHAR
#define CDR_Stream_serialize_wchar(__s,__i) \
    CDR_Stream_serialize_unsigned_long(__s,__i)
#define CDR_Stream_serialize_wstring(__s,__i,__m) \
    CDR_Stream_serialize_wstring32_from_unsigned_long(__s,__i,__m)
#else
#define CDR_Stream_serialize_wchar(__s,__i) \
    CDR_Stream_serialize_wchar32_from_unsigned_short(__s,__i)
#define CDR_Stream_serialize_wstring(__s,__i,__m) \
    CDR_Stream_serialize_wstring32_from_unsigned_short(__s,__i,__m)
#endif

#if CDR_ENABLE_32WCHAR
#define CDR_Stream_deserialize_wchar(__s,__i) \
        CDR_Stream_deserialize_unsigned_long(__s,__i)
#define CDR_Stream_deserialize_wchar(__s,__i,__m) \
    CDR_Stream_deserialize_wstring32_to_unsigned_long(__s,__i,__m)
#else
#define CDR_Stream_deserialize_wchar(__s,__i) \
    CDR_Stream_deserialize_wchar32_to_unsigned_short(__s,__i)
#define CDR_Stream_deserialize_wstring(__s,__i,__m) \
    CDR_Stream_deserialize_wstring32_to_unsigned_short(__s,__i,__m)
#endif
...
struct DDS_TypePlugin;            /* forward declaration */
 ...
 */
MUST_CHECK_RETURN CDRDllExport RTI_UINT32
CDR_get_max_size_serialized_non_primitive_array(void *data,
                                                RTI_UINT32 current_alignment,
                                                RTI_UINT32 length,
...
/*ci
 * \brief
 * Deserialize a byte sequence from a stream without making a copy
 *
 * \param[in] cdrs Deserialization stream
 * \param[out] out Sequence of bytes
 * \param[in] type Type of sequence element
 *
 * \return RTI_TRUE on success, RTI_FALSE on failure.
 */
 ...
 */
MUST_CHECK_RETURN CDRDllExport RTI_UINT32
CDR_get_max_size_serialized_non_primitive_sequence(void *data,
                                                   RTI_UINT32 current_alignment,
                                                   RTI_UINT32 length,
                                                   CDR_Stream_GetSerializedSizeFunction
                                                   get_serialized_size_func);
...
MUST_CHECK_RETURN CDRDllExport RTI_UINT32
CDR_get_max_size_serialized_binary_property(
        void *data,
        RTI_UINT32 current_alignment);

MUST_CHECK_RETURN CDRDllExport RTI_UINT32
CDR_get_max_size_serialized_data_holder(
        void *data,
        RTI_UINT32 current_alignment);

MUST_CHECK_RETURN RTI_UINT32
CDR_get_max_size_serialized_data_tag(
        void *data,
        RTI_UINT32 current_alignment);
