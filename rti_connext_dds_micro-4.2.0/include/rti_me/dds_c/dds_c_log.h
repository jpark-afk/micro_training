...
/*e
 * \brief Inconsisten type-plugin DataReader.
 * \ingroup DDSCLogCodesClass
 */
 ...
 *        DomainParticipantQos.participant_name.name aleady exists.
 * \ingroup DDSCLogCodesClass
 *
 * \details
 *
...
/*e
 * \brief Faile to send DomainParticipant interceptor state
 * \ingroup DDSCLogCodesClass
 */
...
/*e
 * \brief Failed to reutrn authenticated peer credential token
 * \ingroup DDSCLogCodesClass
 */
...
/*e
 * \brief Failed to encode outogoing serialized payload
 * \ingroup DDSCLogCodesClass
 */
...
/*e
 * \brief Mamimum number of buffers excedeed
 * \ingroup DDSCLogCodesClass
 */
 ...
 ******************************************************************************/
/*e
 * \brief Fully qualified name does not cointain substring "::"
 * \ingroup DDSCLogCodesClass
 */
...
/*e
 * \brief Failed to get an entity because the specified name excees the maximum
 *        length of 255 octets (excluding the terminating NUL)
 * \ingroup DDSCLogCodesClass
 */
 ...
 ******************************************************************************/
/*e
 * \brief Failed to creaste flow controller
 * \ingroup DDSCLogCodesClass
 */
 ...
 ******************************************************************************/
/*e
 * \brief Mamimum size of buffer excedeed
 * \ingroup DDSCLogCodesClass
 */
