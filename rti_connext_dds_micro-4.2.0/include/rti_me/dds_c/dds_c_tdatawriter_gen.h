 ...
 *               source files do not need to undefine dds_c_tdatawriter_gen_h
 *               before including this header.
 * 16sep2012,eh  Created
 */
/*i @file
...
#define TData_create_data_c(TData) concatenate(TData, _create)
#define TData_create_data TData_create_data_c(TData)

#define TData_delete_data_c(TData) concatenate(TData, _delete)
#define TData_delete_data TData_delete_data_c(TData)
...
DDS_ReturnCode_t
TDataWriter_get_loan(TDataWriter* self, TData** sample)
{
    return DDS_DataWriter_get_loan((DDS_DataWriter *)self, (void**)sample);
}

DDS_ReturnCode_t
TDataWriter_discard_loan(TDataWriter* self, TData* sample)
{
    return DDS_DataWriter_discard_loan((DDS_DataWriter *)self, (void*)sample);
}

TData*
TDataWriter_create_data(TDataWriter* self)
{
    UNUSED_ARG(self);
    return TData_create_data();
}

#ifndef RTI_CERT
DDS_Boolean
TDataWriter_delete_data(TDataWriter* self, TData* sample)
{
    UNUSED_ARG(self);
    TData_delete_data(sample);
...
#undef TData_create_data
#undef TData_create_data_c

#undef TData_delete_data
#undef TData_delete_data_c
