...
class DDSCPPDllExport DDSDataReader : public DDSEntity
{
  ...
  public:
    ...
    */
    ...
    /*e \dref_DataReader_read_instance_untyped
    */
    ...
    /*e \dref_DataReader_take_instance_untyped
    */
    ...
    */
    ...
    /*e \dref_DataReader_lookup_instance_untyped
    */
    virtual DDS_InstanceHandle_t lookup_instance_untyped(
            const void *key_holder) = 0;

    /*e \dref_DataReader_is_data_consistent_untyped
     */
    virtual DDS_ReturnCode_t is_data_consistent_untyped(
            DDS_Boolean& is_data_consistent,
            const void* sample,
            const DDS_SampleInfo& sample_info) = 0;
    ...
    */
    ...
    virtual DDS_ReturnCode_t get_matched_publications(
            DDS_InstanceHandleSeq &publication_handles) = 0;
    ...
    virtual DDS_ReturnCode_t get_matched_publication_data(
                ...
                const DDS_InstanceHandle_t &publication_handle) = 0;
...
class DDSCPPDllExport DDSDataReader_impl : public DDSDataReader
{
  ...
  public:
    ...
    DDS_ReturnCode_t is_data_consistent_untyped(
            DDS_Boolean& is_data_consistent,
            const void* sample,
