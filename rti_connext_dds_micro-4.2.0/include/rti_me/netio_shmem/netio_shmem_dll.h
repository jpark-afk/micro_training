/*
 * FILE: netio_shmem_dll.h - netio_shmem external linkage
 *
...
#ifndef RTI_netio_shmem_DLL_EXPORT
#define RTI_netio_shmem_DLL_EXPORT
#endif
...
#define NETIO_SHMEM_INTEGRATED_NETIOPSL 0
#else
#define NETIO_SHMEM_INTEGRATED_NETIOPSL 1
#endif

#ifndef NETIOPSLDllExport
#if defined(RTI_netiopsl_DLL_EXPORT) || \
    (NETIO_SHMEM_LINKED_NETIOPSL &&  defined(RTI_netio_shmem_DLL_EXPORT))
...
#define NETIOPSLDllExport
    ...
    (NETIO_SHMEM_INTEGRATED_NETIOPSL &&  defined(RTI_netio_shmem_DLL_VARIABLE))
#if defined(RTI_netiopsl_DLL_EXPORT) || \
    (NETIO_SHMEM_INTEGRATED_NETIOPSL &&  defined(RTI_netio_shmem_DLL_EXPORT))
...
#if defined(RTI_netio_shmem_DLL_EXPORT)
#define NETIO_SHMEMDllExport __declspec( dllexport )
#else
#define NETIO_SHMEMDllExport
#endif /* RTI_NETIO_NAME_DLL_EXPORT */

#if defined(RTI_netio_shmem_DLL_VARIABLE)
#if defined(RTI_netio_shmem_DLL_EXPORT)
#define NETIO_SHMEMDllVariable __declspec( dllexport )
#else
#define NETIO_SHMEMDllVariable __declspec( dllimport )
#endif /* RTI_NETIO_NAME_DLL_EXPORT */
#else
#define NETIO_SHMEMDllVariable
