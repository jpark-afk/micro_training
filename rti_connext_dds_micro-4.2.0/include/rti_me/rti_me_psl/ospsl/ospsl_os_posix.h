...
/* Atomics are only used for ZCOPYv2 and POSIX robust mutexes in the shared
 * memory transport. Certain platforms may not support atomics.
 */
#if RTIME_HAVE_ZCOPYV2 || RTI_HAVE_POSIX_ROBUST_MUTEX
#include "rti_me_psl/ospsl/ospsl_os_posix_atomic.h"
#endif
