 ...
 */
#define RTI_XCDR_XTYPES_DHEADER_IN_NON_PRIMITIVE_COLLECTIONS_BIT (0x00000001U << 0U)
 ...
 * Only applies to V2 encapsulation.
 */
#define RTI_XCDR_XTYPES_ENUM_AS_PRIMITIVE_IN_COLLECTIONS_BIT (0x00000001U << 1U)
 ...
 */
#define RTI_XCDR_XTYPES_PARAMETER_LENGTH_WITH_PADDING_BIT (0x00000001U << 2U)
 ...
 * aligned offset.
 */
#define RTI_XCDR_XTYPES_ENCAPSULATION_OPTIONS_WITH_PADDING_BIT \
        (0x00000001U << 3U)
 ...
 * To be compatible with the XTypes specification this bit must be unset.
 */
#define RTI_XCDR_XTYPES_ACCEPT_UNKNOWN_ENUM_VALUE_BIT (0x00000001U << 4U)
 ...
 * To be compatible with the XTypes specification this bit must be set.
 */
#define RTI_XCDR_XTYPES_ACCEPT_UNKNOWN_DISCRIMINATOR_BIT (0x00000001U << 5U)
 ...
 * is not set.
 */
#define RTI_XCDR_XTYPES_SELECT_DEFAULT_DISCRIMINATOR_BIT (0x00000001U << 6U)
 ...
 * be set.
 */
#define RTI_XCDR_XTYPES_SENTINEL_IN_EMPTY_UNION_BIT (0x00000001U << 7U)
