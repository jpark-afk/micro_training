...
#if defined(USE_SAMPLE_FILTER) && defined(FILTER_ON_DESERIALIZE)
                       ...
                       char *peer, DDS_Long sleep_time, DDS_Long count)
{
    ...
    if (application->count != 0)
    {
        printf("Running for %d seconds, press Ctrl-C to exit\n",
               application->count);
        OSAPI_Thread_sleep((RTI_UINT32)(application->count * 1000));
    }
    else
    {
        ...
        OSAPI_Thread_sleep((RTI_UINT32)(sleep_loop_left * 1000));
    }
