    ...
    DDS_Long count)
{
    ...
    *DDS_StringSeq_get_reference(&dp_qos.user_traffic.enabled_transports,0) = DDS_String_dup("_dgram://");
    ...
    snprintf(application->type_name,
            sizeof(application->type_name),
            "HelloWorld");
