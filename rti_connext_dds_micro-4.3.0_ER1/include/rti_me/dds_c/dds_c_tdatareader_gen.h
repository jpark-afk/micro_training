 ...
 *               source files do not need to undefine dds_c_tdatareader_gen_h
...
#define TDataReader_is_data_consistent_c(TDataReader) concatenate(TDataReader, _is_data_consistent)
#define TDataReader_is_data_consistent TDataReader_is_data_consistent_c(TDataReader)
...
DDS_ReturnCode_t
TDataReader_is_data_consistent(TDataReader *self,
                               DDS_Boolean *is_data_consistent,
                               const TData *sample,
                               const struct DDS_SampleInfo *sample_info)
{
    return DDS_DataReader_is_data_consistent((DDS_DataReader *)self,
                                          is_data_consistent,
                                          (const void*)sample,
                                          sample_info);
}
...
#undef TDataReader_is_data_consistent_c
#undef TDataReader_is_data_consistent
