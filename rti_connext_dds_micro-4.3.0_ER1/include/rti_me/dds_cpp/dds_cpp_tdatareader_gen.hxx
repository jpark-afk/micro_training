...
06jun2014,as  Added compiler error on incorrect use of template header;
              source files do not need to undefine dds_c_tdatareader_gen_hxx
...
DDS_ReturnCode_t
TDataReader::is_data_consistent(
        DDS_Boolean &is_data_consistent,
        const TData& sample,
        const DDS_SampleInfo &sample_info)
{
    return this->is_data_consistent_untyped(is_data_consistent, &sample, sample_info);
}
