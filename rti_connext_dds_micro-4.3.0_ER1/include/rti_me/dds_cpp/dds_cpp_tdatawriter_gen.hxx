...
DDS_ReturnCode_t
TDataWriter::get_loan(TData*& instance_data)
{
    return this->get_loan_untyped((void**)&instance_data);
}

DDS_ReturnCode_t
TDataWriter::discard_loan(TData& instance_data)
{
    return this->discard_loan_untyped((void*)&instance_data);
}

TData*
TDataWriter::create_data()
{
    return TDataTypeSupport::create_data();
}

bool
TDataWriter::delete_data(TData* sample)
{
    TDataTypeSupport::delete_data(sample);
    return true;
}
