 ...
 *
 * (c) Copyright 2011-2025 Real-Time Innovations,
 *
 * All rights reserved.
 *
...
/*e
 * \brief Failed to deserialize a parameter of unknown ID
 * \ingroup DPDELogCodesClass
 */
...
#define DPDE_LOG_ASSERT_REMOTE_PUBLICATION(level_,topic_,ddsrc_) \
OSAPI_LOG_ENTRY_ADD_1STRING_1INT((level_),DPDE_LOG_ASSERT_REMOTE_PUBLICATION_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM ,"topic",(topic_),"ddsrc",(ddsrc_))
...
#define DPDE_LOG_ASSERT_REMOTE_SUBSCRIPTION(level_,topic_,ddsrc_) \
OSAPI_LOG_ENTRY_ADD_1STRING_1INT((level_),DPDE_LOG_ASSERT_REMOTE_SUBSCRIPTION_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM ,"topic",(topic_),"ddsrc",(ddsrc_))
...
OSAPI_LOG_ENTRY_ADD_1UINT((level_),DPDE_LOG_ADD_PEER_EC,\
...
OSAPI_LOG_ENTRY_ADD_1UINT((level_),DPDE_LOG_REMOVE_PEER_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM,"entity_",(entity_))

/*e
 * \brief Failed to serialize Presentation parameter
 * \ingroup DPDELogCodesClass
 */
#define DPDE_LOG_SERIALIZE_PRESENTATION_EC                  (DPDE_LOG_BASE + 60)
#define DPDE_LOG_SERIALIZE_PRESENTATION(level_) \
OSAPI_LOG_ENTRY_ADD((level_),DPDE_LOG_SERIALIZE_PRESENTATION_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM)

/*e
 * \brief Failed to unregister a built-in type for discovery
 * \ingroup DPDELogCodesClass
 */
#define DPDE_LOG_UNREGISTER_TYPE_EC                         (DPDE_LOG_BASE + 61)
#define DPDE_LOG_UNREGISTER_TYPE(level_,type_)\
OSAPI_LOG_ENTRY_ADD_1STRING(level_,DPDE_LOG_UNREGISTER_TYPE_EC,\
                            OSAPI_LOG_MSG_PN_X2_STD_PARAM,\
                           "type name", type_)

/*e
 * \brief Failed to add routes to a remote participant
 * \ingroup DPDELogCodesClass
 */
#define DPDE_LOG_ADD_REMOTE_PARTICIPANT_ROUTES_FAILED_EC    (DPDE_LOG_BASE + 62)
#define DPDE_LOG_ADD_REMOTE_PARTICIPANT_ROUTES_FAILED(level_) \
OSAPI_LOG_ENTRY_ADD((level_),DPDE_LOG_ADD_REMOTE_PARTICIPANT_ROUTES_FAILED_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM)

/*e
 * \brief Failed to delete routes to a remote participant
 * \ingroup DPDELogCodesClass
 */
#define DPDE_LOG_DELETE_REMOTE_PARTICIPANT_ROUTES_FAILED_EC    (DPDE_LOG_BASE + 63)
#define DPDE_LOG_DELETE_REMOTE_PARTICIPANT_ROUTES_FAILED(level_) \
OSAPI_LOG_ENTRY_ADD((level_),DPDE_LOG_DELETE_REMOTE_PARTICIPANT_ROUTES_FAILED_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM)

/*e
 * \brief Failed remove a remote participant
 * \ingroup DPDELogCodesClass
 */
#define DPDE_LOG_REMOVE_REMOTE_PARTICIPANT_EC              (DPDE_LOG_BASE + 64)
#define DPDE_LOG_REMOVE_REMOTE_PARTICIPANT(level_,ddsrc_) \
OSAPI_LOG_ENTRY_ADD_1INT((level_),DPDE_LOG_REMOVE_REMOTE_PARTICIPANT_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM ,"ddsrc",(ddsrc_))

/*e
 * \brief A participant with incompatible checksum was discovered and ignored
 * \ingroup DPDELogCodesClass
 */
#define DPDE_LOG_CHECKSUM_INCOMPATIBLE_PARTICIPANT_IGNORED_EC (DPDE_LOG_BASE + 65)
#define DPDE_LOG_CHECKSUM_INCOMPATIBLE_PARTICIPANT_IGNORED(level_) \
OSAPI_LOG_ENTRY_ADD((level_),DPDE_LOG_CHECKSUM_INCOMPATIBLE_PARTICIPANT_IGNORED_EC,\
        OSAPI_LOG_MSG_PN_X2_STD_PARAM)
