...
/*ci \brief Maximum length of a serialized property name based on
     serialized Participant properties.
 */
#define CDR_PROPERTY_NAME_MAX_SERIALIZED_LEN  24

/*ci \brief Maximum length of a property name
 */
#define CDR_PROPERTY_NAME_MAX_LEN   255

/*ci \brief Average length of a serialized property value based on
 *   serialized Participant.
 *
 * \details
 * Note that this length may be less than an actual serialized property value
 * length, but when calculating the maximum size of the serialization buffer,
 * the maximum number of properties multiplied with this value will be
 * sufficient.
 */
#define CDR_PROPERTY_VALUE_MAX_SERIALIZED_LEN  40

/*ci \brief Maximum length of a property value
 */
