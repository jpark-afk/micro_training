...
typedef enum
{
    ...
    /*ci
     * \brief A record has already been inserted
     */
    DB_RETCODE_RECORD_INSERTED,

    /*ci
     * \brief A record has already been inserted
     */
    DB_RETCODE_INVALID_RECORD,
 ...
 *
 */
MUST_CHECK_RETURN DBDllExport OSAPI_Mutex_T*
...
SHOULD_CHECK_RETURN DBDllExport DB_ReturnCode_T
DB_Table_select_from(DB_Table_T table,DB_Index_T index,
                     DB_Cursor_T *cursor,
                     DB_Key_T from);
