...
/* Only 4 properties are serialized for the participant builtin topic data,
 * so we can limit the maximum number of properties to 4 for the builtin
 * topic data:
 *
 ...
 */
#define DDSC_PARTICIPANT_MAX_PROPERTIES   (4)
...
/*ce \dref_ParticipantBuiltinTopicData_INITIALIZER
 */
...
/*ce \dref_PublicationBuiltinTopicData_INITIALIZER
 */
...
/*ce \dref_SubscriptionBuiltinTopicData_INITIALIZER
 */
