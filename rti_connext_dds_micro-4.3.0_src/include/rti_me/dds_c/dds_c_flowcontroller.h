...
/*ci
 * \brief lookup a flowcontroller by name marks it to being used by a DataWriter.
 * \return DDS_FlowController if successfully acquired, NULL otherwise
*/
DDSCDllExport DDS_FlowController*
DDS_DomainParticipant_acquire_flowcontroller(DDS_DomainParticipant *self,
                                            const char *name);
typedef DDS_FlowController*
(*DDS_DomainParticipant_acquire_flowcontroller_T)(DDS_DomainParticipant *self,
                                            const char *name);

/*ci
 * \brief releases a flow controller that was previously acquired by a DataWriter
 * \return DDS_BOOLEAN_TRUE if successfully released, DDS_BOOLEAN_FALSE otherwise
 */
DDSCDllExport DDS_Boolean
DDS_DomainParticipant_release_flowcontroller(DDS_DomainParticipant *self,
                                            DDS_FlowController *fc);
typedef DDS_Boolean
(*DDS_DomainParticipant_release_flowcontroller_T)(DDS_DomainParticipant *self,
                                            DDS_FlowController *fc);
