 ...
 */
#define DDS_TIME_INVALID_SEC -1

/*e
 * \dref_Time_t_INVALID_NSEC
 */
#define DDS_TIME_INVALID_NSEC 0xFFFFFFFF
...
/*ce \dref_Time_t_is_invalid
 */
#define DDS_Time_is_invalid(timePtr) \
        ((RTI_BOOL)(((timePtr)->sec == DDS_TIME_INVALID_SEC) && \
         ((timePtr)->nanosec == DDS_TIME_INVALID_NSEC)))
 ...
 */
#define DDS_DURATION_INFINITE_NSEC_INITIALIZER 0x7fffffffUL

/*i \brief Internal constant for infinite nanoseconds
 */
#define DDS_DURATION_INFINITE_NSEC_INITIALIZER_OLD 0xffffffffUL
 ...
 *
 * \return DDS_BOOLEAN_TRUE if (end - begin) > delta, DDS_BOOLEAN_FALSE otherwise
 */
DDSCDllExport DDS_Boolean
...
/* ----------------------------------------------------------------- */
#include "dds_c/dds_c_transport_priority_qos.h"


/* ----------------------------------------------------------------- */
/*                TransportEncapsulationQosPolicy                    */
/* ----------------------------------------------------------------- */
/*e \dref_DataEncapsulationQosGroupDocs */

/*e \dref_EncapsulationId_t
 */
...
/*e \dref_ENCAPSULATION_ID_SHMEM_V2
 */
...
#ifdef DOXYGEN_DOCUMENTATION_ONLY
/*e \dref_EncapsulationIdSeq
 */
struct DDS_EncapsulationIdSeq {};
#endif

/*e \dref_TransportEncapsulationSettings_t
 */
struct DDS_TransportEncapsulationSettings_t
{
    ...
    */
    ...
    /*e \dref_TransportEncapsulationSettings_t_encapsulations
    */
...
#ifdef DOXYGEN_DOCUMENTATION_ONLY
/*e \dref_TransportEncapsulationSettingsSeq
 */
struct DDS_TransportEncapsulationSettingsSeq {};
#endif

/*e \dref_TransportEncapsulationQosPolicy
 */
struct DDSCPPDllExport DDS_TransportEncapsulationQosPolicy
{
    /*e \dref_TransportEncapsulationQosPolicy_value
     */
...
/*i \dref_DDS_INVALID_DATA_REPRESENTATION
 */
...
#ifdef DOXYGEN_DOCUMENTATION_ONLY
/*e \dref_DataRepresentationIdSeq
 */
...
/*i \dref_DataRepresentationQosPolicy_DEFAULT
 */
...
/*i \dref_ChecksumProperty_t
 */
struct DDSCPPDllExport DDS_ChecksumProperty
{
    /*i \dref_ChecksumProperty_t_computed_crc_kind
     */
    DDS_ChecksumKind_t computed_crc_kind;

    /*i \dref_ChecksumProperty_t_allowed_crc_mask
     */
    DDS_ChecksumKindMask_t allowed_crc_mask;

    /*i \dref_ChecksumProperty_t_require_crc
     */
    DDS_Boolean require_crc;
};
...
/*ci \brief Empty locator sequence which can be used instead of passing
 *    NULL pointers to a sequence.
 */
extern DDSCDllVariable const struct DDS_LocatorSeq DDS_NullLocatorSeq;
...
/*e \dref_Locator_t_INVALID */
const struct DDS_Locator_t DDS_LOCATOR_INVALID;
/*e \dref_Locator_t_KIND_UDPv4 */
const DDS_Long DDS_LOCATOR_KIND_UDPv4;
/*e \dref_Locator_t_KIND_UDPv6 */
const DDS_Long DDS_LOCATOR_KIND_UDPv6;
/*e \dref_Locator_t_KIND_RESERVED */
const DDS_Long DDS_LOCATOR_KIND_RESERVED;
/*e \dref_Locator_t_KIND_SHMEM */
const DDS_Long DDS_LOCATOR_KIND_SHMEM;
#else
#define DDS_LOCATOR_ADDRESS_LENGTH_MAX RTPS_LOCATOR_ADDRESS_LENGTH_MAX
...
/* DDS_LocatorEx is used to support extended locators with encapsulations. This
 * is currently limited to ZCv1 using the shared memory transport. The first
 * 3 attributes are compatible with DDS_Locator, while the last 2 are specific
 * to the extended locator. The function DDS_Locator_is_extended is used to
 * determine if a DDS_Locator base is extended. Functions are provided to
 * convert between DDS_LocatorSeq and DDS_LocatorExSeq. It is important to
 * note that a DDS_LocatorSeq must only be accessed using the DDS_LocatorSeq
 * API, and a DDS_LocatorExSeq must only be accessed using the
 * DDS_LocatorExSeq API.
 */
/*e \dref_Locator_t
 */
struct DDS_LocatorEx
{
    ...
    /*i \dref_LocatorDataEx_length
     */
    RTI_INT16  length;

    /*i \dref_LocatorDataEx_encapsulations
     */
...
/*i \dref_ProtocolVersion_t
 */
struct DDS_ProtocolVersion
{
    /*i \dref_ProtocolVersion_t_major
     */
    DDS_Octet major;

    /*i \dref_ProtocolVersion_t_minor
     */
    DDS_Octet minor;
};
...
#define DDS_ProtocolVersion_t struct DDS_ProtocolVersion
...
/*i \dref_ProductVersion_t
 */
struct DDS_ProductVersion
{
    /*i \dref_ProductVersion_t_major
     */
    DDS_Char major;

    /*i \dref_ProductVersion_t_minor
     */
    DDS_Char minor;

    /*i \dref_ProductVersion_t_release
     */
    DDS_Char release;

    /*i \dref_ProductVersion_t_revision
     */
    DDS_Char revision;
};
...
struct DDSCPPDllExport DDS_DomainParticipantResourceLimitsQosPolicy
{
    ...
    /*i \dref_DomainParticipantResourceLimitsQosPolicy_matching_reader_writer_pair_allocation
     */
