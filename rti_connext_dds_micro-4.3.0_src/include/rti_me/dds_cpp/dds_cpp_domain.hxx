...
class DDSCPPDllExport DDSDomainParticipant : public DDSEntity
{
  ...
  public:
    ...
    /*e \dref_DomainParticipant_announce
     */
    virtual DDS_ReturnCode_t announce() = 0;

    /*e \dref_DomainParticipant_remove_discovered_participants
     */
    virtual DDS_ReturnCode_t remove_discovered_participants() = 0;
