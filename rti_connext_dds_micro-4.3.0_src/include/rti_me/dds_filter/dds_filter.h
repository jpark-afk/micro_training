...
#if DDS_ENABLE_SQL_FILTER
/*e \dref_SQL_PREDICATE_MAX_COUNT_PER_EXPRESSION_DEFAULT
 */
#define DDS_SQL_PREDICATE_MAX_COUNT_PER_EXPRESSION_DEFAULT 4

/*e \dref_SqlFilterProperty
 */
struct DDSCPPDllExport DDS_SqlFilterProperty
{
    /*e \dref_SqlFilterProperty_predicate_max_count_per_expression
     */
    DDS_Long predicate_max_count_per_expression;
};

#define DDS_SqlFilterProperty_INITIALIZER \
{ \
    DDS_SQL_PREDICATE_MAX_COUNT_PER_EXPRESSION_DEFAULT \
}
