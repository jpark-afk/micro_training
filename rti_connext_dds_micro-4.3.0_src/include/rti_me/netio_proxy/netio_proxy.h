...
NETIO_PROXYDllExport RTI_INT32
NETIO_PROXYInterface_get_packet_count(struct NETIO_PROXYInterface *proxy);

NETIO_PROXYDllExport RTI_INT32
NETIO_PROXYInterface_get_datap_count(struct NETIO_PROXYInterface *proxy);
