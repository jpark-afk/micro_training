...
/*e \dref_OSAPITimeGroupDocs
 */

/*i \defgroup OSAPI_TimeClass OSAPI Time
 *  \ingroup OSAPIModule
 */
...
/*i \ingroup OSAPITimeClass
 * Initializer for OSAPI_SystemTime
 */
#define OSAPI_SystemTime_INITIALIZER  {0,0}
 ...
 *         a positive integer if time1 > time2
 *         a negative integer if time1 < time2
 */
