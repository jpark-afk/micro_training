 ...
 *
 * Copyright 2008-2023 Real-Time Innovations, Inc. All rights reserved.
 *
...
#define REDA_BUFFERPOOL_TRACE (0)

#if REDA_BUFFERPOOL_TRACE
#define REDA_BUFFERPOOL_TRACE_ENABLED (1)
#else
#define REDA_BUFFERPOOL_TRACE_ENABLED (0)
#endif
 ...
 */
#define REDA_BUFFERPOOL_FLAG_ARRAY_ALLOC (0x1U)
...
REDADllExport void
REDA_BufferPool_return_buffer_(REDA_BufferPool_T pool,void *buffer,char *file,RTI_INT32 lineno);
#define REDA_BufferPool_return_buffer(pool_,buffer_) \
    REDA_BufferPool_return_buffer_(pool_,buffer_,__FILE__,__LINE__)
#else
REDADllExport void
