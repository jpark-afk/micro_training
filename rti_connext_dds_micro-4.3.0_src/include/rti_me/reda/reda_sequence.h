...
/* Initialize a REDA sequence structure for a type with loaned data */
#define REDA_DEFINE_SEQUENCE_INITIALIZER_W_LOAN(b_, m_, l_, t_) \
{ (void*)(b_),(m_),(l_),sizeof(t_),NULL,NULL,REDA_SEQUENCE_FLAG_LOAN }
...
/*ci
 * \brief Replace the i-th element with the last element and shorten the
 ...
 * to the sequence and is not considered part of the content.
 *
 * \param[in] self Sequence update
 * \param[in] i The element to replace with the last element.
 *
 */
REDADllExport void
