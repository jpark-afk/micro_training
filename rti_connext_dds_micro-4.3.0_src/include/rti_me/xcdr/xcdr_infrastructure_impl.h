...
#define RTIXCdrUtility_pointerToUnsignedLongLong(pointer__) \
    ((RTIXCdrUnsignedLongLong) (pointer__))
...
#define RTIXCdrType_copyEnum(out__, in__)                  \
    (((void *) (out__) == NULL || (void *) (in__) == NULL) \
             ? RTI_XCDR_FALSE                              \
             : (*(out__) = *(in__), RTI_XCDR_TRUE))
...
#define RTIXCdrType_copyInt8(out__, in__)                 \
    (((void *) (out__) == NULL || (void *) (in__) == NULL) \
             ? RTI_XCDR_FALSE                              \
             : (*(out__) = *(in__), RTI_XCDR_TRUE))

#define RTIXCdrType_copyUInt8(out__, in__)                 \
    (((void *) (out__) == NULL || (void *) (in__) == NULL) \
             ? RTI_XCDR_FALSE                              \
             : (*(out__) = *(in__), RTI_XCDR_TRUE))
...
#define RTIXCdrType_initArray(value__, length__, elementSize__) \
    (((void *) (value__) == NULL) \
             ...
             : (RTIXCdrMemory_zero( \
                        (value__), \
                        (RTIXCdrUnsignedLong) ((elementSize__) * (length__))), \
                RTI_XCDR_TRUE))

#define RTIXCdrType_initArrayUnsafe(value__, length__, elementSize__)       \
    RTIXCdrMemory_zero((value__), ((elementSize__) * (length__)))

#define RTIXCdrType_initLong(value__) \
    (((void *) (value__) == NULL)     \
             ? RTI_XCDR_FALSE         \
             : (*(value__) = (RTIXCdrLong) 0, RTI_XCDR_TRUE))

#define RTIXCdrType_initUnsignedShort(value__) \
    (((void *) (value__) == NULL)              \
             ? RTI_XCDR_FALSE                  \
             : (*(value__) = (RTIXCdrUnsignedShort) 0, RTI_XCDR_TRUE))

#define RTIXCdrType_initString(value__, maximumLength__) \
    RTIXCdrType_initArray( \
            (value__), \
            (maximumLength__), \
            (RTIXCdrUnsignedLong) sizeof(RTIXCdrChar))
