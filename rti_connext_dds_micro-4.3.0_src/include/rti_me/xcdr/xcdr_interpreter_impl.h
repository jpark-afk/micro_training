...
#define RTIXCdrInterpreterProgramsGenProperty_toTypePluginProperty( \
    ...
    (tpProperty)->xTypesComplianceMask = (self)->xTypesComplianceMask;
...
struct RTIXCdrInterpreterPrograms {
    ...
    /* Global XTypes Compliance mask at the time of assertion */
    RTIXCdrXTypesComplianceMask globalXTypesComplianceMask;
    ...
    { \
        NULL,         /* topLevelType */ \
                ...
                RTIXCdrInterpreterProgramsGenProperty_INITIALIZER, /* property \
                                                                    */ \
                RTI_XCDR_XTYPES_COMPLIANCE_MASK_DEFAULT, /* globalXTypesComplianceMask \
                                                          */ \
                RTI_XCDR_PROGRAM_MASK_NONE,              /* mask */ \
                NULL, /* topLevelPrograms */ \
                { { { NULL, NULL }, { NULL, NULL } }, \
                  { { NULL, NULL }, { NULL, NULL } } }, /* serializeProgram */ \
                { { { NULL, NULL }, { NULL, NULL } }, \
                  { { NULL, NULL }, { NULL, NULL } } }, /* deserializeProgram \
                                                         */ \
                { { { NULL, NULL }, { NULL, NULL } }, \
                  { { NULL, NULL }, { NULL, NULL } } }, /* skipProgram */ \
