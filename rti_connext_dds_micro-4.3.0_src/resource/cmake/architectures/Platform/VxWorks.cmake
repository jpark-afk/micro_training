...
# NOTE: Use -DRTIME_VXWORKS_DISABLE_MUNCHING:BOOL=TRUE on cmake to disable munching
IF ((NOT RTIME_VXWORKS_DISABLE_MUNCHING) AND (NOT ${RTIME_TARGET_NAME} MATCHES "_rtp"))
...
IF (MUNCH)
    ...
    ENDIF()
ELSE()
    SET(CMAKE_CXX_CREATE_SHARED_LIBRARY "${CMAKE_C_COMPILER} ${VX_C_FLAGS} <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")
ENDIF()
