...
SET(RTI_PREPROCESS_SOURCE_SUFFIX "c.i")

foreach(m ${MODULE_LIST})

    if ((DEFINED ${m}_EXPORT_NAME) AND
        (NOT ${m} MATCHES "testsuite"))
        ...
        foreach(f ${${m}_SOURCE})
            if (NOT ${f} MATCHES ".*/IDL_*")        
                ...
                add_custom_command(OUTPUT ${target_file}.${RTI_PREPROCESS_SOURCE_SUFFIX}
                                   COMMAND ${CMAKE_COMMAND} 
                                           --build ${RTIME_CMAKE_ROOT} 
                                           --config Debug -- ${target_file}.${RTI_PREPROCESS_SOURCE_SUFFIX}
                                   DEPENDS ${f}
                )
                ...
                IF (NOT RTI_NO_SHARED_LIB)
                    add_custom_command(OUTPUT ${RTIME_CMAKE_ROOT}/CMakeFiles/${${m}_EXPORT_NAME}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.objdump
                                       COMMAND ${RTIME_OBJDUMP} ${RTIME_OBJDUMP_OPT} ${RTIME_CMAKE_ROOT}/CMakeFiles/${${m}_EXPORT_NAME}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.${RTIME_OBJ_SUFFIX} > ${RTIME_CMAKE_ROOT}/CMakeFiles/${${m}_EXPORT_NAME}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.objdump
                                       DEPENDS ${f}
                    )
                ENDIF()
                ...
                IF (NOT RTI_NO_SHARED_LIB)
                    add_custom_command(OUTPUT ${RTIME_CMAKE_ROOT}/CMakeFiles/${${m}_EXPORT_NAME}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.chksum
                                       COMMAND ${CMAKE_COMMAND}
                                               -DRTIME_OBJDUMPCHKSUM=${RTIME_OBJDUMPCHKSUM} 
                                               -DRTIME_OBJDUMPCHKSUM_OPT="${RTIME_OBJDUMPCHKSUM_OPT}" 
                                               -DRTIME_OBJFILE=${target_file}.${target_file_suffix}.${RTIME_OBJ_SUFFIX}
                                               -DRTIME_OBJCHKSUMFILE=${target_file}.${target_file_suffix}.objchksum 
                                               -DRTIME_WORKING_DIR=${RTIME_CMAKE_ROOT}/CMakeFiles/${${m}_EXPORT_NAME}${RTI_LIB_SUFFIX_DYNAMIC}.dir
                                               -DRTIME_OUTPUT_FILE=${RTIME_MODULE_EXPORT_ROOT}/lib/${RTIME_TARGET_NAME}/checksum${RTI_LIB_SUFFIX_DYNAMIC} -P ${RESOURCEHOME}/cmake/cmake_chksum_make.cmake
                                       WORKING_DIRECTORY ${RTIME_CMAKE_ROOT}/CMakeFiles/${${m}_EXPORT_NAME}${RTI_LIB_SUFFIX_DYNAMIC}.dir
                                       DEPENDS ${f}
                    )                
                ENDIF()
                            
                list(APPEND ${lib_name}_PREPROCESSED_FILES "${target_file}.${RTI_PREPROCESS_SOURCE_SUFFIX}")
                ...
                IF (NOT RTI_NO_SHARED_LIB)
                    list(APPEND ${lib_name}_OBJECTCHKSUM_FILES_SHARED "${RTIME_CMAKE_ROOT}/CMakeFiles/${${m}_EXPORT_NAME}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.chksum")
                ENDIF()
            endif()        
        endforeach()
        ...
        foreach(m ${${m}_OBJECT_DEPENDS})
            foreach(f ${${m}_SOURCE})
                if (NOT ${f} MATCHES ".*/IDL_*")
                    ...
                    IF (NOT RTI_NO_SHARED_LIB)
                        add_custom_command(OUTPUT ${RTIME_CMAKE_ROOT}/CMakeFiles/${lib_name}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.objdump
                                           COMMAND ${RTIME_OBJDUMP} ${RTIME_OBJDUMP_OPT} ${RTIME_CMAKE_ROOT}/CMakeFiles/${lib_name}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.${RTIME_OBJ_SUFFIX} > ${RTIME_CMAKE_ROOT}/CMakeFiles/${lib_name}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.objdump
                                           DEPENDS ${f}
                        )
                    ENDIF()
                    ...
                    IF (NOT RTI_NO_SHARED_LIB)
                        add_custom_command(OUTPUT ${RTIME_CMAKE_ROOT}/CMakeFiles/${lib_name}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.chksum
                                           COMMAND ${CMAKE_COMMAND} 
                                                   -DRTIME_OBJDUMPCHKSUM=${RTIME_OBJDUMPCHKSUM} 
                                                   -DRTIME_OBJDUMPCHKSUM_OPT="${RTIME_OBJDUMPCHKSUM_OPT}"
                                                   -DRTIME_OBJFILE=${target_file}.${target_file_suffix}.${RTIME_OBJ_SUFFIX}
                                                   -DRTIME_OBJCHKSUMFILE=${target_file}.${target_file_suffix}.objchksum 
                                                   -DRTIME_WORKING_DIR=${RTIME_CMAKE_ROOT}/CMakeFiles/${lib_name}${RTI_LIB_SUFFIX_DYNAMIC}.dir
                                                   -DRTIME_OUTPUT_FILE=${RTIME_MODULE_EXPORT_ROOT}/lib/${RTIME_TARGET_NAME}/checksum${RTI_LIB_SUFFIX_DYNAMIC} -P ${RESOURCEHOME}/cmake/cmake_chksum_make.cmake
                                           WORKING_DIRECTORY ${RTIME_CMAKE_ROOT}/CMakeFiles/${lib_name}${RTI_LIB_SUFFIX_DYNAMIC}.dir
                                           DEPENDS ${f}
                        )                    
                    ENDIF()
                    ...
                    IF (NOT RTI_NO_SHARED_LIB)
                        list(APPEND ${lib_name}_OBJECTDUMP_FILES_SHARED "${RTIME_CMAKE_ROOT}/CMakeFiles/${lib_name}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.objdump")
                    ENDIF()                    
                    ...
                    IF (NOT RTI_NO_SHARED_LIB)
                        list(APPEND ${lib_name}_OBJECTCHKSUM_FILES_SHARED "${RTIME_CMAKE_ROOT}/CMakeFiles/${lib_name}${RTI_LIB_SUFFIX_DYNAMIC}.dir/${target_file}.${target_file_suffix}.chksum")
                    ENDIF()                    
                endif()
...
add_custom_target(objchksum_clean
                  ...
                  COMMAND ${CMAKE_COMMAND} -E remove -f ${RTIME_MODULE_EXPORT_ROOT}/lib/${RTIME_TARGET_NAME}/checksum${RTI_LIB_SUFFIX_DYNAMIC}
)
...
IF (NOT RTI_NO_SHARED_LIB)
    add_custom_target(objchksum
                      COMMAND ${CMAKE_COMMAND}
                        ...
                        -DRTIME_OUTPUT_FILE=${RTIME_MODULE_EXPORT_ROOT}/lib/${RTIME_TARGET_NAME}/checksum${RTI_LIB_SUFFIX_DYNAMIC}
