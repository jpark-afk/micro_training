 ...
 *
 * (c) Copyright, Real-Time Innovations, 2012-2018. All rights reserved.
 *
 ...
 *
 * \param[inout] cdrs Deserialization stream
 *
                              ...
                              RTI_UINT16 *out_kind)
{
    ...
    if (!CDR_Stream_deserialize_unsigned_short_from_big_endian(cdrs, out_kind))
    {
        return RTI_FALSE;
    }
