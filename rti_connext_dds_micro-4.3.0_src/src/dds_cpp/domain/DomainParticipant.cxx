...
DDS_Publisher*
DDSDomainParticipant_create_publisher(
        ...
        DDS_StatusMask mask)
{
        ...
        (listener == NULL) && (mask == DDS_STATUS_MASK_NONE))
    {
        participant = (DDSDomainParticipant*)
                 DDS_Entity_get_wrapper(DDS_DomainParticipant_as_entity(self));

        if (participant != NULL)
        {
            publisher = participant->create_publisher(*qos, NULL,
                                                      DDS_STATUS_MASK_NONE);

            if (publisher != NULL)
            {
                ret_value = (DDS_Publisher*)publisher->get_c_entity();
            }
        }
    }
...
DDS_Subscriber*
DDSDomainParticipant_create_subscriber(
        DDS_DomainParticipant *self,
        ...
        DDS_StatusMask mask)
{
        ...
        (listener == NULL) && (mask == DDS_STATUS_MASK_NONE))
    {
        ...
        if (participant != NULL)
        {
            subscriber = participant->create_subscriber(*qos, NULL,
                                                        DDS_STATUS_MASK_NONE);

            if (subscriber != NULL)
            {
                ret_value = (DDS_Subscriber*)subscriber->get_c_entity();
            }
        }
    }
...
DDS_Topic*
DDSDomainParticipant_create_topic(
        DDS_DomainParticipant *self,
        ...
        DDS_StatusMask mask)
{
        ...
        (listener == NULL) && (mask == DDS_STATUS_MASK_NONE))
    {
        ...
        if (participant != NULL)
        {
            ...
            if (topic != NULL)
            {
                ret_value = (DDS_Topic*)topic->get_c_entity();
            }
        }
    }
...
#ifndef RTI_CERT
DDS_ReturnCode_t
DDSDomainParticipant_delete_contained_entities(
        DDS_DomainParticipant *self)
{
    DDSDomainParticipant *participant;
    DDS_ReturnCode_t ret_value = DDS_RETCODE_BAD_PARAMETER;
    ...
    if (self != NULL)
    {
        ...
        if (participant != NULL)
        {
            ret_value = participant->delete_contained_entities();
        }
    }
...
#if DDS_ENABLE_APPGEN
DDSPublisher*
DDSDomainParticipant_impl::lookup_publisher_by_name(
    const char *publisher_name)
{
    DDSPublisher *result = NULL;
    DDS_Publisher *c_publisher = NULL;

    c_publisher = DDS_DomainParticipant_lookup_publisher_by_name(
                      (DDS_DomainParticipant*)this->_c_entity, publisher_name);
    if (c_publisher != NULL)
    {
        result = (DDSPublisher*) DDS_Entity_get_wrapper(
...
DDSSubscriber*
DDSDomainParticipant_impl::lookup_subscriber_by_name(
    const char *subscriber_name)
{
    DDSSubscriber *result = NULL;
    DDS_Subscriber *c_subscriber = NULL;

    c_subscriber = DDS_DomainParticipant_lookup_subscriber_by_name(
                      (DDS_DomainParticipant*)this->_c_entity, subscriber_name);
    if (c_subscriber != NULL)
    {
        result = (DDSSubscriber*) DDS_Entity_get_wrapper(
...
DDSDataWriter*
DDSDomainParticipant_impl::lookup_datawriter_by_name(
    const char *datawriter_full_name)
{
    DDSDataWriter *result = NULL;
    DDS_DataWriter *c_writer = NULL;

    c_writer = DDS_DomainParticipant_lookup_datawriter_by_name(
                   (DDS_DomainParticipant*)this->_c_entity, datawriter_full_name);
    if (c_writer != NULL)
    {
        result = (DDSDataWriter*) DDS_Entity_get_wrapper(
                                         DDS_Publisher_as_entity(c_writer));
    }
...
DDSDataReader*
DDSDomainParticipant_impl::lookup_datareader_by_name(
    const char *datareader_full_name)
{
    DDSDataReader *result = NULL;
    DDS_DataReader *c_reader = NULL;

    c_reader = DDS_DomainParticipant_lookup_datareader_by_name(
                   (DDS_DomainParticipant*)this->_c_entity, datareader_full_name);
    if (c_reader != NULL)
    {
...
DDS_ReturnCode_t
DDSDomainParticipant_impl::assert_liveliness()
{
...
#if INCLUDE_API_LOOKUP
DDS_ReturnCode_t
DDSDomainParticipant_impl::get_discovered_participants(
            DDS_InstanceHandleSeq &participant_handles)
{
    return DDS_DomainParticipant_get_discovered_participants(
                (DDS_DomainParticipant*)this->_c_entity,
                &participant_handles);
}

DDS_ReturnCode_t
DDSDomainParticipant_impl::get_discovered_participant_data(
            DDS_ParticipantBuiltinTopicData &participant_data,
            const DDS_InstanceHandle_t &participant_handle)
{
    return DDS_DomainParticipant_get_discovered_participant_data(
                (DDS_DomainParticipant*)this->_c_entity, &participant_data,
                &participant_handle);
}
...
DDS_ReturnCode_t
DDSDomainParticipant_impl::announce()
{
    return DDS_DomainParticipant_announce(
                        (DDS_DomainParticipant*)this->_c_entity);
}

DDS_ReturnCode_t
DDSDomainParticipant_impl::remove_discovered_participants()
{
    return DDS_DomainParticipant_remove_discovered_participants(
                        (DDS_DomainParticipant*)this->_c_entity);
}
