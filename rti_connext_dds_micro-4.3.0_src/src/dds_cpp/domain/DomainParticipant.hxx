...
class DDSDomainParticipant_impl : public DDSDomainParticipant
{
  ...
  public:
    ...
    DDSPublisher* lookup_publisher_by_name(
        const char *publisher_name);

    DDSSubscriber* lookup_subscriber_by_name(
        const char *subscriber_name);

    DDSDataWriter* lookup_datawriter_by_name(
    ...
    DDS_TypePluginI* unregister_type(
        const char *type_name);
    ...
    DDS_ReturnCode_t announce();

    DDS_ReturnCode_t remove_discovered_participants();

#if DDS_FLOW_CONTROLLER_ENABLED
    /*e \dref_DomainParticipant_get_default_flowcontroller_property
     */
    DDS_ReturnCode_t
    get_default_flowcontroller_property(DDS_FlowControllerProperty_t &prop);
     ...
     */
    DDS_ReturnCode_t
    delete_flowcontroller( DDSFlowController *fc);

    /*e \dref_DomainParticipant_lookup_flowcontroller
     */
    DDSFlowController*
    lookup_flowcontroller(const char *name);
...
#ifndef RTI_CERT
DDS_ReturnCode_t
DDSDomainParticipant_delete_contained_entities(DDS_DomainParticipant *self);
#endif /* !RTI_CERT */
#endif /* DDS_ENABLE_APPGEN */
}
