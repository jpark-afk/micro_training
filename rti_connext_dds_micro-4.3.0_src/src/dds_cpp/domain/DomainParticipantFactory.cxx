...
#ifndef RTI_CERT
#define DDS_AppGen_EntityManager_CPP_DELETE_INITIALIZER \
    , DDSDomainParticipantFactory_delete_participant    \
    , DDSDomainParticipant_delete_contained_entities
#else
#define DDS_AppGen_EntityManager_CPP_DELETE_INITIALIZER
#endif

#define DDS_AppGen_EntityManager_CPP_INITIALIZER    \
{                                                   \
    DDSDomainParticipantFactory_create_participant, \
    ...
    DDS_AppGen_EntityManager_CPP_DELETE_INITIALIZER \
}
...
DDSDomainParticipantFactory_create_participant
                       (DDS_DomainParticipantFactory *self,
                        ...
                        DDS_StatusMask mask)
{
    DDSDomainParticipantFactory* cpp_factory =
    ...
    {
        participant = cpp_factory->create_participant(domain_id, *qos, NULL,
                                                      DDS_STATUS_MASK_NONE);

        if (participant != NULL)
        {
            ret_value = (DDS_DomainParticipant*)participant->get_c_entity();
        }
    }
                         ...
                         DDS_DomainParticipant *a_participant)
{
    ...
    if ((cpp_factory != NULL) && (a_participant != NULL))
    {
        participant = (DDSDomainParticipant *)
                          DDS_Entity_get_wrapper(
                              DDS_DomainParticipant_as_entity(a_participant));

        if (participant != NULL)
        {
            ret_value = cpp_factory->delete_participant(participant);
        }
    }
    ...
    DDS_StatusMask mask) 
{
    ...
    DDS_DomainParticipant_set_flowcontroller_finalizer(
            c_participant,
            DDSFlowController_impl::DDSFlowController_impl_delete);
#endif
...
#if DDS_ENABLE_APPGEN
DDSDomainParticipant*
DDSDomainParticipantFactory_impl::create_participant_from_config(
        const char* configuration_name)
{
    struct DDS_AppGen_EntityManager entity_manager = 
                                        DDS_AppGen_EntityManager_CPP_INITIALIZER;
    DDS_DomainParticipant *participant;
    DDSDomainParticipant *ret_value = NULL;
    ...
    if (participant != NULL)
    {
        ret_value = (DDSDomainParticipant*) DDS_Entity_get_wrapper(
...
#if DDS_ENABLE_APPGEN
DDSDomainParticipant*
DDSDomainParticipantFactory_impl::lookup_participant_by_name(
            const char* participant_name)
{
    ...
    c_participant =
        DDS_DomainParticipantFactory_lookup_participant_by_name(
                this->_c_domain_part_factory, participant_name);
