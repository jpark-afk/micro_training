/* 
 ...
 (c) Copyright, Real-Time Innovations, 2013-2026.
 All rights reserved.
...
===================================================================== */
  ...
  #include "dds_cpp/dds_cpp_namespace.hxx"
    ...
    const char * const &DDS::DEFAULT_FLOW_CONTROLLER_NAME = DDS_DEFAULT_FLOW_CONTROLLER_NAME;
    const char * const &DDS::FIXED_RATE_FLOW_CONTROLLER_NAME = DDS_FIXED_RATE_FLOW_CONTROLLER_NAME;
    const char * const &DDS::ON_DEMAND_FLOW_CONTROLLER_NAME = DDS_ON_DEMAND_FLOW_CONTROLLER_NAME;

    const DDS_FlowControllerSchedulingPolicy DDS::RR_FLOW_CONTROLLER_SCHED_POLICY = DDS_RR_FLOW_CONTROLLER_SCHED_POLICY;
    const DDS_FlowControllerSchedulingPolicy DDS::EDF_FLOW_CONTROLLER_SCHED_POLICY = DDS_EDF_FLOW_CONTROLLER_SCHED_POLICY;
    const DDS_FlowControllerSchedulingPolicy DDS::HPF_FLOW_CONTROLLER_SCHED_POLICY = DDS_HPF_FLOW_CONTROLLER_SCHED_POLICY;

    const DDS_PublishModeQosPolicyKind DDS::SYNCHRONOUS_PUBLISH_MODE_QOS = DDS_SYNCHRONOUS_PUBLISH_MODE_QOS;
    const DDS_PublishModeQosPolicyKind DDS::ASYNCHRONOUS_PUBLISH_MODE_QOS = DDS_ASYNCHRONOUS_PUBLISH_MODE_QOS;
    const DDS_PublishModeQosPolicyKind DDS::AUTOMATIC_PUBLISH_MODE_QOS = DDS_AUTOMATIC_PUBLISH_MODE_QOS;
#endif
