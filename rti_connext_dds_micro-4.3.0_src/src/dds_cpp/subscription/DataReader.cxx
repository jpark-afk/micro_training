...
DDS_TypeCode*
DDSDataReader_impl::get_typecode()
{
    return DDS_DataReader_get_typecode((DDS_DataReader*) this->_c_entity);
}
#endif
...
DDS_ReturnCode_t
DDSDataReader_impl::is_data_consistent_untyped(
            DDS_Boolean& is_data_consistent,
            const void *sample,
            const DDS_SampleInfo& sample_info)
{
    return DDS_DataReader_is_data_consistent(
            (DDS_DataReader*) this->_c_entity,
            &is_data_consistent,
            sample,
            &sample_info);
...
DDS_ReturnCode_t
DDSDataReader_impl::get_matched_publications(
            DDS_InstanceHandleSeq &publication_handles)
{
    return DDS_DataReader_get_matched_publications(
                (DDS_DataReader*) this->_c_entity,
                &publication_handles);
}

DDS_ReturnCode_t
DDSDataReader_impl::get_matched_publication_data(
                DDS_PublicationBuiltinTopicData &publication_data,
                const DDS_InstanceHandle_t &publication_handle)
{
    return DDS_DataReader_get_matched_publication_data(
                (DDS_DataReader*) this->_c_entity, &publication_data,
                &publication_handle);
}
