 ...
 *
 * Copyright 2008-2015 Real-Time Innovations, Inc. All rights reserved.
 *
...
RTI_PRIVATE void
RTPS_Bitmap_reset_value(struct RTPS_Bitmap *me,
...
RTPS_Bitmap_reset(struct RTPS_Bitmap *me,
                  ...
                  RTI_INT32 bit_count)
{
    RTPS_Bitmap_reset_value(me,sn,bit_count,0);
}
                        ...
                        RTI_BOOL search_bit)
{
    ...
    RTI_UINT32 value;
    RTI_INT32 extra_bits, valid_bits;
    RTI_INT32 j = 0,i = 0, bit_array_size = 0;
                        ...
                        RTI_UINT32 shift_value)
{
    ...
    {
        /* 0 fill */
        RTPS_Bitmap_reset_value(me, seq_num, me->bit_count,shift_value);
        goto success;
    }
...
RTPS_Bitmap_shift(struct RTPS_Bitmap *me,
                  const struct REDA_SequenceNumber *seq_num)
{
    return RTPS_Bitmap_shift_value(me,seq_num,0);
}
...
#define ELEMENT_MASK (31)
    ...
    /* Do not count outside the receive window, cannot < 0 */
    ...
    /* Justification: max_distance <= bit_count. bit_count has a max value
     * of 256 so max_distance is at most 256. 255 + 31 = 287, which is
     * less than INT_MAX. max_distance + ELEMENT_MASK can't overflow.
     */
    /* coverity[overflow_const] */
    element_count = (max_distance + ELEMENT_MASK) >> 5;
 ...
 * \param[in] is_32bit_lead If TRUE, deserialize the lead as 32 bit
 *                          unsigned long in the low integer and set
 *                          high integer to 0. This is used for FragmentSets
 *
                        ...
                        RTI_BOOL is_32bit_lead)
{
    ...
    {
        me->lead.high = 0;
        CDR_deserialize_unsigned_long(&stream, &me->lead.low, need_byte_swap);
    }
    else
    {
