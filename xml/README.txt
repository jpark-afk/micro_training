...
objs/x64Linux3gcc4.8.2/HelloWorld_subscriber  [-sleep <sleep_time>] [-count <count>]

and run the publisher by typing:

objs/x64Linux3gcc4.8.2/HelloWorld_publisher  [-sleep <sleep_time>] [-count <count>]
